...
public class PostArticle extends BaseClass {
	...
	public void writeArticle() throws InterruptedException {
		...
		Thread.sleep(2000);
		headline.sendKeys(property.getProperty("headline"));
		Thread.sleep(2000);
		articleDesc.sendKeys(property.getProperty("articleDesc"));
		articleCTA.click();
		Thread.sleep(2000);
		articleCTAVideo.click();
		Utility.uploadItems(property.getProperty("youtubeurl"));
		Thread.sleep(7000);
		publish.click();
		Thread.sleep(2000);
		aboutArticle.sendKeys(property.getProperty("aboutArticle"));
		Thread.sleep(2000);
